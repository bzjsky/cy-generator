...
import com.cy.generator.util.PropertiesHelper;
import com.cy.generator.util.typemapping.DatabaseTypeUtils;
...
public class GeneratorProperties {
	...
	public static String getDatabaseType(Map p,String key) {
		...
		String jdbcDriver = (String)p.get(com.cy.generator.GeneratorConstants.JDBC_DRIVER.code);
	...
	public static String getProperty(com.cy.generator.GeneratorConstants key) {
	...
	public static String getRequiredProperty(com.cy.generator.GeneratorConstants key) {
	...
	public static String getNullIfBlank(com.cy.generator.GeneratorConstants key) {
	...
	public static String[] getStringArray(com.cy.generator.GeneratorConstants key) {
	...
	public static boolean getBoolean(com.cy.generator.GeneratorConstants key) {
