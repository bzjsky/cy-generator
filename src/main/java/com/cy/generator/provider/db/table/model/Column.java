...
import com.cy.generator.provider.db.table.model.ForeignKey.ReferenceKey;
import com.cy.generator.provider.db.table.model.Table;
import com.cy.generator.provider.db.table.model.util.ColumnHelper;
import com.cy.generator.util.GLogger;
import com.cy.generator.util.StringHelper;
import com.cy.generator.util.TestDataGenerator;
...
import com.cy.generator.util.typemapping.JdbcType;
...
public class Column implements java.io.Serializable,Cloneable{
	 ...
	 */
	private com.cy.generator.provider.db.table.model.Table _table;
	 ...
	 * @param remarks
	 */
	public Column(com.cy.generator.provider.db.table.model.Table table, int sqlType, String sqlTypeName,
