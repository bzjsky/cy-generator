...
import com.cy.generator.provider.db.table.model.Column.EnumMetaDada;
import com.cy.generator.util.Inflector;
...
//	    return StringHelper.makeAllWordFirstLetterUpperCase(StringHelper.toUnderscoreName(dbName));
    ...
    */
    public static String pluralize(String word) {
        return com.cy.generator.util.Inflector.getInstance().pluralize(word);
//        String result = name;
//        if (name.length() == 1) {
//            // just append 's'
//            result += 's';
